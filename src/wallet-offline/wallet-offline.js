// //offline implementation of cardano wallet ALL IN ONE. **Reference only**
...
// //create hardened path num for root key
// const harden = (num) => {
...
//     //time to live
//     await txBuilder.set_ttl(55858914 + 200);
...
//     console.log(
//       "CBOR unsigned:",
//       await Buffer.from(newTx.to_bytes()).toString("hex")
//     );
...
//     console.log("CBOR encoded transaction:", txHex);
